...
async function handleRequestRoute(url) {
    const routes = [
        ...
        { pattern: /\/(shows|movies|media)\/trending(\?|$)/, handler: () => handleMediaList("media trending") },
        { pattern: /\/(shows|movies|media)\/recommendations(\?|$)/, handler: () => handleMediaList("media recommendations") },
        { pattern: /\/(shows|movies|media)\/anticipated(\?|$)/, handler: () => handleMediaList("media anticipated") },
        { pattern: /\/(shows|movies|media)\/popular(\/next)?(\?|$)/, handler: () => handleMediaList("media popular next") },
